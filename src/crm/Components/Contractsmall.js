...
function Contractsmall({show, setShow}) {

    setShow(false);

    return (
            <CRMMainDiv>
                <CRMDiv className={show===false && "big" }>
                    ...
                    <TabList className="tabs_nav">
                        <Dropdown>
                            ...
                            <DropdownMenu className="open_customer" style={{ inset: "auto" }}>
                                <DropdownItem href="/crm/add_customers" className="customer_choose" >Yeni Müştəri</DropdownItem>
                                <DropdownItem href="/crm/customer_card_basas" className="customer_choose" >Müştərilər</DropdownItem>
                            </DropdownMenu>
                        </Dropdown>
                        <a className="tabs_headers" href="/crms">Müqavilələr</a>
                    </TabList>
                </BlueLine>
                <MainDiv>
                    <LeftMainDiv>
                        <a className="card_title" href="/crm/custom_card">Əliyev Fərid Kamran <img className="vip_svg" src={vip} alt="vip" /></a>
