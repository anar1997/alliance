...
function AddInterruption({ empoyeeID}) {
  ...
  useEffect(() => {
    const cony = `https://dev.kodaze.com/api/v1/salaries/salary-deduction/`;
  ...
  return (
    <FullScreen className="h-full">
      <form className="calendar_div" onSubmit={handleSubmit}>
        <p className="holiday_title">Kəsinti əlavə etmək üçün aşağıdakı sətirləri doldurun.</p>
